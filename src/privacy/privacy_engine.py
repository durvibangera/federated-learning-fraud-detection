...
class Privacy_Engine:
    ...
    def __init__(
        ...
        logger.info(f"Initialized Privacy_Engine with ε={epsilon}, δ={delta}, "
    ...
    def make_private(
        ...
        try:
            ...
            logger.info(f"Privacy parameters: max_grad_norm={self.max_grad_norm}, "
    ...
    def get_privacy_spent(self) -> Tuple[float, float]:
        ...
        try:
            ...
            if epsilon_spent > self.epsilon:
                logger.warning(f"Privacy budget exhausted! Spent {epsilon_spent:.4f} > "
                             f"target {self.epsilon:.4f}")
...
class Privacy_Utility_Analyzer:
    ...
    def __init__(
        self,
        target_epsilons: List[float] = [0.5, 1.0, 2.0, 4.0, 8.0],
        delta: float = 1e-5,
        max_grad_norm: float = 1.0
    ):
        """
    ...
    def get_summary_statistics(self) -> Dict[str, Any]:
        ...
        logger.info(f"Privacy-utility summary: AUPRC degradation={auprc_degradation:.4f}, "
