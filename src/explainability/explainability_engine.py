...
class Explainability_Engine:
    ...
    def explain_prediction(
        ...
        try:
            ...
            logger.info(f"Generated explanation: prediction={prediction:.4f}, "
    ...
    def get_global_feature_importance(
        ...
        try:
            ...
            logger.info(f"Global feature importance computed. "
                       f"Top feature: {list(sorted_importance.keys())[0]}")
    ...
    def generate_explanation_summary(
        ...
        summary = {
            ...
            'top_features_overall': [
                {'feature': f, 'avg_importance': float(imp)}
                for f, imp in top_features_overall
            ]
        }
