...
class Evaluation_System:
    ...
    def evaluate_model(
        ...
        logger.info(f"{dataset_name} - AUPRC: {metrics['auprc']:.4f}, "
    ...
    def evaluate_per_bank(
        self,
        bank_dataloaders: Dict[str, DataLoader],
        compute_ci: bool = True
    ...
    def compute_convergence(
        ...
        logger.debug(f"Convergence check: score={convergence_score:.4f}, "
    ...
    def set_baseline_metrics(self, metrics: Dict[str, float]) -> None:
        ...
        logger.info(f"Set baseline metrics: AUPRC={metrics.get('auprc', 0):.4f}, "
    ...
    def compare_to_baseline(
        ...
        logger.info(f"Baseline comparison - AUPRC degradation: "
                   f"{comparison.get('auprc_degradation_pct', 0):.2f}%")
    ...
    def export_evaluation_report(
        ...
        report = {
            ...
            'num_rounds_evaluated': len(self.history)
        }
