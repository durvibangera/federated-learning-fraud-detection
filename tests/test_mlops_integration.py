...
class TestGrafanaDashboardConfiguration:
    ...
    def test_grafana_datasource_config(self):
        ...
        datasource_path = Path(__file__).parent.parent / 'monitoring' / 'grafana' / 'provisioning' / 'datasources' / 'prometheus.yaml'
...
class TestErrorHandlingAndRecovery:
    ...
    def test_mlflow_connection_failure_handling(self):
        ...
        logger = MLflow_Logger(
            tracking_uri="http://invalid-host:9999",
