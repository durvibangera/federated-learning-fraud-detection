...
def categorical_features():
    ...
    return ["ProductCD", "card4", "card6", "P_emaildomain", "R_emaildomain", "M1", "M2"]
...
def sample_privacy_config():
    ...
    return {"epsilon": 1.0, "delta": 1e-5, "max_grad_norm": 1.0, "noise_multiplier": 1.1}


@pytest.fixture
def sample_fl_config():
    """Sample federated learning configuration for testing."""
    return {"num_rounds": 30, "min_clients": 2, "min_available_clients": 3, "proximal_mu": 0.01, "local_epochs": 5}
...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "requires_data: mark test as requiring IEEE-CIS dataset")
